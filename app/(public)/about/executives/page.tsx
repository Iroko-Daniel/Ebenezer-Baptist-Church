    ...
    <div>
      ...
      {selectedExecutive && (
        ...
        >
          ...
          >
            {/* Close Button */}
            <div className="sticky top-0 bg-white px-5 pt-4 pb-2 flex justify-end">
              <button
                onClick={() => setSelectedExecutive(null)}
                className="bg-gray-100 hover:bg-gray-200 text-gray-700 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition"
              >
                ✕
              </button>
            </div>
            ...
            <div className="px-5 pb-4">
              <div className="aspect-square overflow-hidden bg-gray-100 rounded-xl max-w-xs mx-auto">
            ...
            <div className="px-6 pb-6 text-center">
              ...
              {selectedExecutive.bio ? (
                <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-line text-left bg-gray-50 rounded-xl p-5">
                  {selectedExecutive.bio}
                </div>
              ) : (
              ...
              <div className="mt-6">
                <button
                  onClick={() => setSelectedExecutive(null)}
                  className="w-full bg-[#1e3a5f] text-white py-3 rounded-lg font-semibold hover:bg-[#2a5a8f] transition shadow-md"
                >
                  Close
                </button>
              </div>
